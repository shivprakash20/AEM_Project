...
@Component(service = WorkflowProcess.class, property = {Constants.SERVICE_DESCRIPTION + "= Process Step for Email Notification",
        ...
        "process.label" + "= Package Replication Email Process"})
public class PackageEmailProcess implements WorkflowProcess {

    private static final Logger logger = LoggerFactory.getLogger(PackageEmailProcess.class);
    private static final String EMAIL_PROFILE = "./profile/email";
    private static final String TEMPLATE_PATH = "/etc/notification/email/acs-commons/email-testing.txt";
    ...
    public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap metaDataMap) throws WorkflowException {
        ...
        String recipients = metaDataMap.get("PROCESS_ARGS", String.class);
        ...
        if(!emailRecipientsList.isEmpty()) {
            ...
            emailService.sendEmail(TEMPLATE_PATH, emailParams, emailList);
        }
    }
