...
@Component(service = WorkflowProcess.class, property = {Constants.SERVICE_DESCRIPTION + "= Package Installation Process Step",
        ...
        "process.label" + "= Backup Package Installation Process"})
public class BackupPackageInstallationProcess implements WorkflowProcess {

    private static final Logger logger = LoggerFactory.getLogger(BackupPackageInstallationProcess.class);
    ...
    public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap metaDataMap) throws WorkflowException {
        try {
            ...
            packagePath = historyMetaDataMap.get("backupPackage").toString();
