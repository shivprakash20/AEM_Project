...
@Component(service = Servlet.class, property = {Constants.SERVICE_DESCRIPTION + "=Learning Scholar Servlet for Data Source and FDM",
        ServletResolverConstants.SLING_SERVLET_PATHS + "=/bin/learningScholarServlet"})
public class LearningScholarServlet extends SlingAllMethodsServlet {

    private static final long serialVersionUID = 1L;
    protected static final Logger LOGGER = LoggerFactory.getLogger(LearningScholarServlet.class);
    ...
    public JSONArray getALLData() {
        ...
        try (Statement statement = connection.createStatement()) {
            String query = "SELECT * FROM aem_sql.scholar";
