 ...
 */
@Component(service = AEMUserDetails.class, immediate = true)
public class AEMUserDetailsImpl implements AEMUserDetails {

    private static final Logger LOGGER = LoggerFactory.getLogger(AEMUserDetailsImpl.class);
